...
public class PatientBmiManaController {
    ...
    public R getPatientBmiManaPage(@ParameterObject Page page,
                                   @ParameterObject PatientBmiManaEntity patientBmiMana) {
    ...
    public R removeById(@RequestBody Long[] ids) {
        return R.ok(
                patientBmiManaService.removeBatchByIds(CollUtil.toList(ids)));
    }
    ...
    public List<PatientBmiManaEntity> export(
            PatientBmiManaEntity patientBmiMana, Long[] ids) {
        return patientBmiManaService.list(Wrappers.lambdaQuery(patientBmiMana)
                                                  .in(ArrayUtil.isNotEmpty(ids),
                                                      PatientBmiManaEntity::getBmiUuid,
                                                      ids));
    }
    ...
    @PreAuthorize("@pms.hasPermission('patient_patientBmiMana_view')")
    public R getByPatientBmiManaObject(
            @RequestBody PatientBmiManaEntity patientBmiMana) {
        LambdaQueryWrapper<PatientBmiManaEntity> wrapper = Wrappers.lambdaQuery();
